...
int main(int argc, char **argv) {
    ...
    // Reuse existing test helpers in a single configuration so that the demo
    // exercises the same core checks as the full test harness.
    int passed = 0;
    int total  = 0;
    ...
    // Propagate failure through the exit code to allow use in scripts or CI.
